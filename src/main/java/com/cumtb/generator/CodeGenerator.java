...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        pc.setParent("com.cumtb");        //父路径(Application.java的父路径)
        ...
        strategy.setRestControllerStyle(false);  //是否开启RestController
